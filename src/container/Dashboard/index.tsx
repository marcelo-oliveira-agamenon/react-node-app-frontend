...
export class dashboard extends React.Component<props> {
  ...
  handleClickExpense(label: string) {
    if (label === "add") {
  ...
  render() {
    const { savingsList, loggedUser, expenseList } = this.props;
    ...
    return (
      <>
        <Header
          userNameText={"Olá, " + loggedUser.info.nameUser}
          userNameStyle={{
            margin: 0,
            fontSize: "2.5vw",
        ...
        >
          ...
          <div style={{ height: "auto", marginLeft: "5.5vw" }}>
            ...
            <button
              ...
              onClick={() => this.handleClickExpense("add")}
            >
              Adicionar Despesa
            </button>
            <button
              ...
              onClick={() => this.handleClickExpense("list")}
            >
              Listar Despesa
            </button>
          </div>
